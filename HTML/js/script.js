(function($) {
    ...
    $('.btn').on('click', function(e) {
        ...
        if (href === "#" || href === "" || $(this).hasClass('toggle-lyrics') || $(this).hasClass('collect-email')) {
            e.preventDefault(); // Don't navigate anywhere
        } else {
            window.location.href = href; // Go to real links
        }
        return false;
    ...
    $('.countdown').countdown('2025/05/04').on('update.countdown', function(event) {
